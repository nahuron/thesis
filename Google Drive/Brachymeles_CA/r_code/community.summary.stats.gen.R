...
#plot standard stacked MPD vs MNTD with viridis
...
plot(seq(from=0.05,to=1.00,by=0.05), results.gen.means$ses.mpd, pch=18, col=rgb(0,0,0,1),  ylim=c(-5,5), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="ses.mpd")
for(c in 1:length(results.gen)){
...
points(seq(from=0.05,to=1.00,by=0.05), results.gen.means$ses.mpd, pch=23, bg=rgb(1,1,1,1), col=rgb(0,0,0,1),  ylim=c(0,1.05), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="ses.mpd", cex=1.75)


#plot standard SES.mntd
plot(seq(from=0.05,to=1.00,by=0.05), results.gen.means$ses.mntd, pch=18, col=rgb(0,0,0,1),  ylim=c(-5,5), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="ses.mntd")
for(c in 1:length(results.gen)){
...
points(seq(from=0.05,to=1.00,by=0.05), results.gen.means$ses.mntd, pch=23, bg=rgb(1,1,1,1), col=rgb(0,0,0,1),  ylim=c(0,1.05), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="ses.mntd", cex=1.75)


#plot standard PSV
plot(seq(from=0.05,to=1.00,by=0.05), results.gen.means$psv, pch=18, col=rgb(0,0,0,1),  ylim=c(0,1.05), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="PSV")
for(c in 1:length(results.gen)){
...
points(seq(from=0.05,to=1.00,by=0.05), results.gen.means$psv, pch=23, bg=rgb(1,1,1,1), col=rgb(0,0,0,1),  ylim=c(0,1.05), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="PSV", cex=1.75)
...
#luzon
plot(seq(from=0.05,to=1.00,by=0.05)-0.01, results.gen.means.l$ses.mpd, pch=18, col=rgb(0,114/255,178/255,1),  ylim=c(-5,4), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="Phylogenetic Dispersion")
abline(h=0, lty=2)
#mindanao
...
#luzon
plot(seq(from=0.05,to=1.00,by=0.05)-0.01, results.gen.means.l$ses.mntd, pch=18, col=rgb(0,114/255,178/255,1),  ylim=c(-5,4), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="Phylogenetic Dispersion")
abline(h=0, lty=2)
#mindanao
...
#luzon
plot(seq(from=0.05,to=1.00,by=0.05)-0.01, results.gen.means.l$psv, pch=18, col=rgb(0,114/255,178/255,1),  ylim=c(0,1.05), xlim=c(0.00,1.05), xlab="Grid Size (Decimal Degrees)", ylab="Phylogenetic Dispersion")
abline(h=0.825, lty=2)
#mindanao
