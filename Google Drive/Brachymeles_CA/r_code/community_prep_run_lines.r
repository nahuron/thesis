...
#mac
setwd("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/locality_data")
...
#mac
read.csv("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/locality_data/Brachymeles.unique.locality.winter2016.csv", header=T)->brachloc
...
setwd("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/")	#work in dropbox folders


brachtree <- read.tree("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Genetic/Brachymeles Chronogram/Newick.tre")

#new phylogeny
brachtree <- read.tree("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Genetic/brach.v2.tre")
...
#easier method for retaining only desired species tips
branches.dropped <- brachtree$tip.label[!brachtree$tip.label %in% c(  "'cebuensis_Cebu.CDS3598'", "'libayani_Lapinig.CDS3645'", "'paeforum_Leyte.CDS3419'", "'samarensis_Samar.CDS3034'", "'lukbani_Labo.RMB9909'", "'minimus_Catanduanes.CDS2371'", "'brevidactylus_Luzon.CDS4099'", "'bicolandia_Luzon.CDS4082'", "'cobos_Catanduanes.CDS5254'", "isangdaliri_Aurora_RMB12651", "mapalanggaon_Masbate_CDS5101", "tridactylus_Negros_CDS3619", "burksi_Mindoro_RMB4896", "bonitae_Polillo_RMB8901", "ilocandia_NLuzGonzaga_CDS3730", "ligtas_Lubang_CDS3929", "'elerae_Kalinga.CDS3482'", "'muntingkamay_Palali.ELR1330'", "'boholensis_Bohol.CDS4470'", "'gracilis_Cotabato.ACD5302'", "'pathfinderi_Glan.CDS5193'", "'tiboliorum_Mindanao.H1641'", "'samad_Leyte.CDS3138'",  "'hilong_MtHilong.CDS5431'", "'vulcani_CamigSur.RMB8223'", "'bicolor_Luzon.RMB11986'", "'makusog_Catanduanes.CDS2369'", "'orientalis_Bohol.CDS4691'", "'schadenbergi_Zambnga.RMB10525'", "'boulengeri.Polillo.CDS1117'", "'mindorensis_Mindoro.CDS1233'", "'taylori_Cebu.CDS3602'", "talinis_Negros_RMB3283", "'kadwa_Luzon.CDS4057'", "'tungaoi_Masbate.CDS5100'" )]
#drop branches and put resulting phylogeny in a new object
culled.brachtree <- drop.tip(brachtree, branches.dropped)
...
#read in tree file
brach <- read.nexus("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Genetic/culledbrachtree_final.nex")

#revise tips to reflect species names
brach$tip.label <- gsub("\\..*","",brach$tip.label)
brach$tip.label <- gsub("_(.*)","",brach$tip.label)
...
psv(samp=allofem, tree=brach)#0.854, revised chronogram is 0.825
...
write.csv(revised.niche.overlaps, file="/Users/nicholashuron/Desktop/revised.niche.overlaps.all.csv", col.names=T, row.names=T)
