...
enm.dirs <- list.dirs("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/ENMS_Fall_2016", recursive = F)
enm.dirs.short <- list.dirs("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/ENMS_Fall_2016",full.names = F, recursive = F)
...
enm.jackknife <- read.csv("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/ENMS_Fall_2016/all_jackknife_brachymeles_results.csv", header=T)
