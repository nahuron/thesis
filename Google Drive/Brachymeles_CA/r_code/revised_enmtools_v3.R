...
setwd("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/")
...
env.files <- list.files(path = "/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/locality_data/climate_data", pattern = "\\.asc$", full.names = TRUE)
env <- stack(env.files)
...
sp.files <- list.files(path = "/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/coords_ENMS", pattern = ".csv$", full.names = TRUE)
...
sp.files2 <- list.files(path = "/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/coords_ENMS", pattern = ".csv$", full.names = FALSE)
...
#save(sp.list, file=paste0("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/","sp.list.v5.rda"))
load("/Users/nicholashuron/Desktop/Huron, Nicholas/thesis/Datasets/Geographic/sp.list.v5.rda")
