...
sp.files <- list.files(path = "/Users/nicholashuron/Desktop/niche_overlap_tests/input", pattern = ".csv$", full.names = TRUE)
...
sp.files2 <- list.files(path = "/Users/nicholashuron/Desktop/niche_overlap_tests/input", pattern = ".csv$", full.names = FALSE)
...
save(sp.list, file=paste0("/Users/nicholashuron/Desktop/niche_overlap_tests/","sp.list.v4.rda"))
